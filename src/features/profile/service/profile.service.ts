...
import { uploadToCloudinary, deleteFromCloudinary, extractPublicId } from '../../../common/utils/cloudinary.helper';
...
export class ProfileService {
    ...
    async updateProfile(
        userId: string,
        dto: UpdateProfileWithPasswordDto,
